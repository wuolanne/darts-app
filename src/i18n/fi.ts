...
export const fi: TranslationDict = {
  ...
  home: {
    ...
    quickCheckoutTitle: "Nopea checkout",
    timedRunTitle: "Aikaa vastaan",
    quickCheckoutDescription: "Piilotettu reitti ja nopea palaute.",
    timedRunDescription: "Suorita checkoutit mahdollisimman nopeasti.",
    aroundDescription: "Ajoitetut sektorit ja kohteet.",
    libraryDescription: "Checkout-reitit ja jatkot.",
    statsDescription: "7 pv / 30 pv / kaikki harjoitustilastot.",
    settingsDescription: "Suosikkitupla, ajastin, teema ja värinäpalaute.",
