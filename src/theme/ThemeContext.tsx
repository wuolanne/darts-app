...
export function ThemeProvider({
  ...
  useEffect(() => {
    ...
    root.style.setProperty("--surface-alt", tokens.surfaceElevated);
    ...
    root.style.setProperty("--border", tokens.cardBorder);
    ...
    root.style.setProperty("--primary-button", tokens.primaryButton);
    root.style.setProperty("--primary-button-text", tokens.primaryButtonText);
    root.style.setProperty("--selected", tokens.selected);
    root.style.setProperty("--selected-border", tokens.selectedBorder);
    root.style.setProperty("--progress", tokens.progress);
    root.style.setProperty("--dartboard-shell", tokens.dartboardShell);
